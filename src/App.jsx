          ...
          weatherData && (
            <div className='flex flex-col justify-center items-center'>
              ...
              <div className='flex flex-col justify-center items-center text-xs sm:text-lg text-center'>
                ...
                <p className='font-light '>High: {isCelsius ? kelvinToCelsius(weatherData.main.temp_max) : kelvinToFahrenheit(weatherData.main.temp_max)}°
                  {isCelsius ? 'C' : 'F'} / Low: {isCelsius ? kelvinToCelsius(weatherData.main.temp_min) : kelvinToFahrenheit(weatherData.main.temp_min)}°
                  {isCelsius ? 'C' : 'F'}
                </p>
